...
function bootstrapDelegationHandler(e, t, n) {
  return function i(s) {
    ...
    for (let {
      ...
      for (const a of o)
        if (a === r) return s.delegateTarget = r, i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(r, [s])
  }
}
...
function addHandler(e, t, n, i, s) {
  ...
  if (n || (n = i, i = null), t in customEvents) {
    const e = e => function (t) {
      if (!t.relatedTarget || t.relatedTarget !== t.delegateTarget && !t.delegateTarget.contains(t.relatedTarget)) return e.call(this, t)
    };
    i ? i = e(i) : n = e(n)
  }
  const [o, r, a] = normalizeParameters(t, n, i), l = getEvent(e), c = l[a] || (l[a] = {}), _ = findHandler(c, r, o ? n : null);
...
const EventHandler = {
    ...
    off(e, t, n, i) {
      if ("string" != typeof t || !e) return;
      const [s, o, r] = normalizeParameters(t, n, i), a = r !== t, l = getEvent(e), c = t.startsWith(".");
      if (void 0 !== o) {
        if (!l || !l[r]) return;
    ...
    trigger(e, t, n) {
      ...
      if (void 0 !== n)
        for (const e of Object.keys(n)) Object.defineProperty(l, e, {
          get: () => n[e]
        });
...
class Dropdown extends BaseComponent {
  constructor(e, t) {
    super(e, t), this._popper = null, this._parent = this._element.parentNode, this._menu = SelectorEngine.findOne(SELECTOR_MENU, this._parent), this._inNavbar = this._detectNavbar()
  }
  static get Default() {
    return Default$9
  }
  ...
  static dataApiKeydownHandler(e) {
    ...
    if (t && !n) return;
    e.preventDefault();
    const s = SelectorEngine.findOne(SELECTOR_DATA_TOGGLE$3, e.delegateTarget.parentNode),
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown || EventHandler.trigger(this._element, EVENT_SHOW$3, {
      ...
      this._config.scroll || this._focustrap.activate(), this._element.classList.add("show"), this._element.classList.remove("showing"), EventHandler.trigger(this._element, EVENT_SHOWN$3, {
        relatedTarget: e
      })
    }), this._element, !0))
  }
...
class TemplateFactory extends Config {
  ...
  _setContent(e, t, n) {
    ...
    i && ((t = this._resolvePossibleFunction(t)) ? isElement(t) ? this._putElementInTemplate(getElement(t), i) : this._config.php ? i.innerHTML = this._maybeSanitize(t) : i.textContent = t : i.remove())
  }
  _maybeSanitize(e) {
...
class Tooltip extends BaseComponent {
  constructor(e, t) {
    ...
    super(e, t), this._isEnabled = !0, this._timeout = 0, this._isHovered = !1, this._activeTrigger = {}, this._popper = null, this._templateFactory = null, this.tip = null, this._setListeners()
  }
  static get Default() {
    return Default$3
  }
  ...
  show() {
    ...
    if (this._element.ownerDocument.documentElement.contains(this.tip) || (i.append(n), EventHandler.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._createPopper(n), n.classList.add("show"), "ontouchstart" in document.documentElement)
      for (const e of [].concat(...document.body.children)) EventHandler.on(e, "mouseover", noop);
    this._queueCallback((() => {
      const e = this._isHovered;
      this._isHovered = !1, EventHandler.trigger(this._element, this.constructor.eventName("shown")), e && this._leave()
  ...
  setContent(e) {
    let t = !1;
    this.tip && (t = this._isShown(), this.tip.remove(), this.tip = null), this._disposePopper(), this.tip = this._createTipElement(e), t && this.show()
  }
  ...
  _createPopper(e) {
    ...
    this._popper = Popper.createPopper(this._element, e, this._getPopperConfig(n))
  }
  _getOffset() {
    const {
      offset: e
  ...
  _setListeners() {
    ...
    for (const t of e)
      if ("click" === t) EventHandler.on(this._element, this.constructor.eventName("click"), this._config.selector, (e => this.toggle(e)));
      else if ("manual" !== t) {
  ...
  _fixTitle() {
    ...
    e && (this._element.getAttribute("aria-label") || this._element.textContent || this._element.setAttribute("aria-label", e), this._element.removeAttribute("title"))
  }
  _enter() {
  ...
  _configAfterMerge(e) {
    return e.container = !1 === e.container ? document.body : getElement(e.container), "number" == typeof e.delay && (e.delay = {
      show: e.delay,
      hide: e.delay
    }), e.originalTitle = this._element.getAttribute("title") || "", e.title = this._resolvePossibleFunction(e.title) || e.originalTitle, "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), e
  }
  _getDelegateConfig() {
    const e = {};
...
class Tab extends BaseComponent {
  ...
  _activate(e, t) {
    ...
    const n = e.classList.contains("fade");
    this._queueCallback((() => {
      n && e.classList.add("show"), "tab" === e.getAttribute("role") && (e.focus(), e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), EventHandler.trigger(e, EVENT_SHOWN$1, {
        relatedTarget: t
      }))
    }), e, n)
  }
  _deactivate(e, t) {
    ...
    const n = e.classList.contains("fade");
    this._queueCallback((() => {
      n && e.classList.remove("show"), "tab" === e.getAttribute("role") && (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), EventHandler.trigger(e, EVENT_HIDDEN$1, {
        relatedTarget: t
      }))
    }), e, n)
  }
